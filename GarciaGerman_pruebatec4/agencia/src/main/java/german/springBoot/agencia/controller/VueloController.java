...
public class VueloController {
    ...
    public String saveHotel(@RequestBody Vuelo vuelo, @RequestParam int cantidadPersonas) {
...
/*
    ...
    public Vuelo getVueloByNumeroVuelo(@PathVariable String numeroVuelo) {
        return vueloService.findVueloByNumeroVuelo(numeroVuelo);
    }*/
